<template>
    <div>
        ...
        <h2 class="h4">Commonwealth Bay area</h2>
        ...
        <h2 class="h4">Ross Sea area</h2>
        <h3 class="h5">Greco-Roman mythology</h3>
        ...
        <h3 class="h5">Roman Britain (Brittania) names</h3>
        <p>Bibra Valley, Banna Peak, Abus Valley, Bellum Valley, Glevum Ridge.</p>

        <h3 class="h5">Māori descriptive names for wind at Mount Terror</h3>
        <p>Parawera Cone, Mūmū Nunatak, Tarakākā Peak, Pōnui Nunatak.</p>

        <h3 class="h5">Others</h3>
        <ul>
            <li>Naval Battles in Admiralty Mountains</li>
            <li>Sled dogs, Lonewolf Nunataks</li>
            <li>NZ birds on Mount Bird (Mount Bird not being bird related)</li>
            <li>Germanic/Norse mythology in Asgard Range</li>
            <li>Bicycle related names around Head Mountains (ie Cycle Glacier)</li>
